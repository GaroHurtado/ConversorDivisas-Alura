...
public class prueba extends JFrame implements Conversor{
	...
	protected String moneda1;
	double valor = 0;
	protected String cambioValor  ;
	...
	public prueba() {
		pruebaHiper label = new pruebaHiper();
		label.setURL("https://github.com/GaroHurtado");
		label.setText("Visita mi GitHub");
		label.setLocation(50, 100);   
		label.setBounds(100, 100, 857, 370);
		...
		convertir.setForeground(new Color(0, 0, 128));
		convertir.setFont(new Font("SansSerif", Font.PLAIN, 21));
		convertir.setBounds(161, 297, 512, 23);
		contentPane.add(convertir);
		
		Salida = new JTextField();
		Salida.setEditable(false);
		Salida.setForeground(new Color(0, 0, 128));
		Salida.setHorizontalAlignment(SwingConstants.CENTER);
		Salida.setFont(new Font("SansSerif", Font.PLAIN, 23));
		...
		entrada.setBounds(161, 74, 512, 22);
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\Usuario\\Desktop\\Material cursos ONE Oracle\\DESAFIOS\\Conversor de moneda\\ConversorMoneda\\imagenes\\Vector.png"));
		lblNewLabel.setBounds(792, 253, 49, 78);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Conversor Divisas");
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1.setFont(new Font("SansSerif", Font.BOLD, 66));
		lblNewLabel_1.setBounds(64, 0, 713, 56);
	...
	public String convertirDe() {
		...
		return (entrdaUsuario + " " + moneda+ " Es igual a: " + String.valueOf(valor ) + " " + this.moneda1);
